//
//  ImageAlbumTableViewController.m
//  xiuxiu
//
...
@interface ImageAlbumTableViewController ()
...
@implementation ImageAlbumTableViewController

static NSString * const reuseIdentifier = @"imageAlbumCell";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ImageAlbumTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier forIndexPath:indexPath];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"imageDetaillPush"]) {
        ImageDetailViewController *albumVC = segue.destinationViewController;
        ImageAlbumTableViewCell *cell = sender;
